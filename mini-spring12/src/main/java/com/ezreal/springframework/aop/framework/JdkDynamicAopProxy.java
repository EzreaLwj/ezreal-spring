...
import com.ezreal.springframework.aop.framework.AopProxy;
import com.ezreal.springframework.aop.framework.ReflectiveMethodInvocation;
...
public class JdkDynamicAopProxy implements AopProxy, InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (methodMatcher.matches(method, advisedSupport.getTargetClass().getClass())) {
            ...
            return methodInterceptor.invoke(new ReflectiveMethodInvocation(advisedSupport.getTargetClass(), method, args));
        }
