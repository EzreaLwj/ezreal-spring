...
import com.ezreal.springframework.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        org.dom4j.Element element = rootElement.element("component-scan");
        if (element != null) {
        ...
        List<org.dom4j.Element> beanList = rootElement.elements("bean");
